...
<head>
	...
	<link rel="stylesheet" href="${ctx}/assets/css/style.css?v=coupon-collapse-20260614">
</head>
<body>
	...
	<script charset="UTF-8" src="${ctx}/assets/js/app.js?v=utf8-login-20260630"></script>
</body>
</html>
