...
<head>
	...
	<link rel="stylesheet" href="${ctx}/assets/css/style.css?v=topbar-search-20260708-1">
</head>
<body>
	...
	<script charset="UTF-8" src="${ctx}/assets/js/app.js?v=topbar-search-20260708-1"></script>
</body>
</html>
